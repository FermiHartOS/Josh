...
static void cmd_help(void) {
    ...
    vga_put_string("  help, clear, fetch, ver, mem, uptime, colors, history, echo, about, panic, halt, reboot, beep, play\n", COLOR_YELLOW);
...
static void cmd_beep(const char* args) {
    char buf[12]; /* DECLARAÇÃO DO BUFFER FALTANTE */
